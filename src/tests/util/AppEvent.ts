...
export const appEventSamples: AppEvent[] = [
  {
    id: 1,
    ...
    payload: {
      ...
      device: {
        ...
        region: 'jp',
        status: 'active',
        createdAt: '2020-04-04T09:44:23.925Z',
        user: {
          id: 'usr_Mw==',
          name: 'kidof',
  ...
  {
    id: 2,
    createdAt: '2021-08-30T08:00:48.948Z',
    type: 'install.create',
    app: {
      id: 'wa_MTAwMw==',
    },
  ...
  {
    id: 3,
    createdAt: '2021-08-30T08:01:37.389Z',
    type: 'install.delete',
    app: {
      id: 'wa_MTAwMw==',
    },
  ...
  {
    id: 4,
    createdAt: '2021-08-30T08:07:05.502Z',
    type: 'install.create',
    app: {
      id: 'wa_MTAwMw==',
    },
...
export const appEventAddSamples: AppEvent[] = [
  {
    id: 5,
    createdAt: '2021-09-01T08:07:05.502Z',
    type: 'install.create',
    app: {
      id: 'wa_MTAwMw==',
    },
...
export const appEventDeleteSamples: AppEvent[] = [
  {
    id: 5,
    createdAt: '2021-09-01T08:07:05.502Z',
    type: 'install.delete',
...
export const appEventDeleteAllDeviceSamples: AppEvent[] = [
  {
    id: 5,
    createdAt: '2021-09-01T08:07:05.502Z',
    type: 'install.delete',
...
export const appEventDeleteAndUpdateSamples: AppEvent[] = [
  {
    id: 5,
    createdAt: '2021-09-01T08:07:05.502Z',
    type: 'install.delete',
